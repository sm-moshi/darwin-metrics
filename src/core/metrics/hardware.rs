...
///
/// ```rust
/// use darwin_metrics::core::metrics::HardwareMonitor;
...
/// Trait for monitoring network interface state
#[async_trait::async_trait]
...
/// Trait for monitoring disk mount points
#[async_trait::async_trait]
...
/// Trait for monitoring process resource usage
#[async_trait::async_trait]
...
/// Trait for monitoring process I/O operations
#[async_trait::async_trait]
