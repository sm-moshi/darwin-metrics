...
#[cfg(test)]
use {
    crate::hardware::iokit::MockIOKit,
    mockall::predicate::*,
    objc2::msg_send,
    objc2::class,
    objc2::rc::{autoreleasepool, Retained},
    objc2::runtime::AnyObject,
    objc2_foundation::{NSDictionary, NSObject, NSString}
};
...
mod tests {
    use super::*;
    use crate::test_utils::create_test_dictionary;
    ...
    mod macos_tests {
        ...
        fn test_get_info_properties_failure() {
            ...
            mock.expect_io_registry_entry_create_cf_properties()
                .returning(|_| Err(Error::system("Failed to get properties")));
