...
use crate::utils::test_utils::create_test_object;
...
impl MockIOKit {
    pub fn new() -> Self {
        Self {
            ...
            battery_power_draw: 0.0,
            battery_design_capacity: 100.0,
            battery_current_capacity: 85.0,
        }
    }
}
...
impl IOKit for MockIOKit {
    ...
    fn get_service_matching(&self, _name: &str) -> Result<Option<ThreadSafeAnyObject>> {
        Ok(Some(ThreadSafeAnyObject::new(unsafe { create_test_object() })))
    }
