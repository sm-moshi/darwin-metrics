...
use crate::utils::bindings::{
    ...
    IOServiceMatching, IOServiceOpen, SMCKeyData_t, SMCKeyData_t_data, SMC_CMD_READ_BYTES,
    SMC_CMD_READ_KEYINFO, IO_RETURN_SUCCESS, KERNEL_INDEX_SMC,
};
