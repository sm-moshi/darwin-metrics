...
use crate::{
    error::Result,
    utils::bindings::{kinfo_proc, proc_info, proc_pidinfo, mach_host_self},
};
...
impl Gpu {
    ...
    fn get_gpu_process_activity(&self) -> Result<f64> {
        ...
        let gpu_process_names = [
            "Metal", "OpenGL", "Unity", "Unreal", "Blender", 
            "Final Cut", "Premiere", "After Effects", "Photoshop", 
            "Lightroom", "DaVinci", "Maya", "Cinema 4D", "Steam",
            "VLC", "QuickTime", "Chrome", "Safari", "Firefox",
        ];
