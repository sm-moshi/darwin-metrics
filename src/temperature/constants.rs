...
/// Default critical temperature threshold for ambient sensor in degrees Celsius
pub const AMBIENT_DEFAULT_CRITICAL_TEMP: f64 = AMBIENT_CRITICAL_TEMPERATURE;

/// Default critical temperature threshold for CPU in degrees Celsius
pub const CPU_DEFAULT_CRITICAL_TEMP: f64 = CPU_CRITICAL_TEMPERATURE;

/// Default critical temperature threshold for GPU in degrees Celsius
pub const GPU_DEFAULT_CRITICAL_TEMP: f64 = GPU_CRITICAL_TEMPERATURE;

/// Default critical temperature threshold for SSD in degrees Celsius
pub const SSD_DEFAULT_CRITICAL_TEMP: f64 = SSD_CRITICAL_TEMPERATURE;

/// Default critical temperature threshold for battery in degrees Celsius
pub const BATTERY_DEFAULT_CRITICAL_TEMP: f64 = BATTERY_CRITICAL_TEMPERATURE;
