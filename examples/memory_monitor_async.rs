...
async fn main() -> Result<(), Box<dyn Error>> {
    println!("Memory Monitor Async Example");
    println!("===========================");
    ...
    for _ in 0..5 {
        ...
        println!("{:<10.2} | {:<12.2} | {:<12.2} | {:<12.2} | {:<7.1}% | {:<12.1}%", 
    ...
    println!("{:<10.2} | {:<10.2} | {:<10.2} | {:<10.2}/s | {:<10.2}/s", 
    ...
    // Check what memory pressure level we're at
    println!("\nCurrent Memory Pressure Level: {}", memory.pressure_level());
    
    // Stop the monitor
    println!("\nStopping memory pressure monitor...");
    monitor.stop();
    println!("Monitor active: {}", monitor.is_active());
